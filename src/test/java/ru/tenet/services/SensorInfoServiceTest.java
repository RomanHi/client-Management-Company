...
public class SensorInfoServiceTest {
    ...
    public void parseResponseForVKT7ExpectedNewCorrectVKTSensorInfo() {
        short[] goodResponse = new short[]{0x00, 0x01, 0x00, 0x00, 0x00, 0x11, 0x0e, //headers and slaveId(last byte)
                0x03, 0x09,0x18,0x25,0x25,0x25,0x25,'c',0x0a,0x0e,0x30};
        SensorInfoService service = new SensorInfoService(SensorType.VKT7);
    ...
    public void parseResponseForTV7ExpectedNewCorrectTV7SensorInfo() {
        short[] goodResponse = new short[]{0x00, 0x01, 0x00, 0x00, 0x00, 0x11, 0x0e, //headers and slaveId(last byte)
                0x03, 0x0e, 0x17, 0x02, 0x02, 0x08, 0x01, 0x08, 0x81, 0x08, 0x03, 0x05, 0xFF, 0xFF, 0xFF, 0xFF};
        short[] badResponse = new short[]{0x02, 0x08, 0x01, 0x08, 0x81, 0x08};
        byte[] b = new byte[]{0x02, 0x08, 0x01, 0x08, (byte) 0x81, 0x08};
        SensorInfoService service = new SensorInfoService(SensorType.TV7);
